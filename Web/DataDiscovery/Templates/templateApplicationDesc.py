...
__CHEETAH_genTime__ = 'Thu Mar 15 12:44:05 2007'
__CHEETAH_srcLastModified__ = 'Sat Mar  3 11:31:22 2007'
__CHEETAH_src__ = 'Templates/tmpl/templateApplicationDesc.tmpl'
__CHEETAH_version__ = '2.0b5'

##################################################
## CLASSES

class templateApplicationDesc(Template):
...
''')
    ...
    _mainCheetahMethod_for_templateApplicationDesc= 'respond'
if not hasattr(templateApplicationDesc, '_initCheetahAttributes'):
    templateClass = getattr(templateApplicationDesc, '_CHEETAH_templateClass', Template)
    templateClass._assignRequiredMethodsToClass(templateApplicationDesc)
...
if __name__ == '__main__':
    ...
    CmdLineIface(templateObj=templateApplicationDesc()).run()
