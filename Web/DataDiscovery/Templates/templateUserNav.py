...
__CHEETAH_genTime__ = 'Thu Mar 15 12:44:51 2007'
__CHEETAH_srcLastModified__ = 'Tue Mar 13 15:28:49 2007'
...
''')
        if VFFSL(SL,"userMode",True):
            ...
            if _v is not None: write(_filter(_v, rawExpr='$dbsInst')) # from line 12, col 44.
            write('" id="kw_dbsInstSelector" />\n')
        else:
            write('''<tr>
<td align="right">
<b>DBS instances</b>
...
<td>
<div class="yellow_box" onMouseOver="KeywordHelp('kw_dbs_tag','<p>List of known DBS instances.</p>')" onMouseOut="ClearTag('kw_dbs_tag')">?</div><span id="kw_dbs_tag"></span></td>
<td>
<select id="kw_dbsInstSelector" onchange="javascript:ajaxGetKWFields()">
''')
            for dbs in VFFSL(SL,"dbsList",True):
                write('<option value="')
                _v = VFFSL(SL,"dbs",True) # $dbs
                if _v is not None: write(_filter(_v, rawExpr='$dbs')) # from line 23, col 16.
                write('">')
                _v = VFFSL(SL,"dbs",True) # $dbs
                if _v is not None: write(_filter(_v, rawExpr='$dbs')) # from line 23, col 22.
                write('</option>\n')
            write('''</select>
</td>
</tr>
...
''')
        for group in VFFSL(SL,"groupList",True):
            ...
            if _v is not None: write(_filter(_v, rawExpr='$group')) # from line 44, col 16.
            write('">')
            _v = VFFSL(SL,"group",True) # $group
            if _v is not None: write(_filter(_v, rawExpr='$group')) # from line 44, col 24.
            write('</option>\n')
        write('''</select>
</div>
...
<option value="Any">Any</option>
''')
        for tier in VFFSL(SL,"dataTypes",True):
            write('<option value="')
            _v = VFFSL(SL,"tier",True) # $tier
            if _v is not None: write(_filter(_v, rawExpr='$tier')) # from line 64, col 16.
            write('">')
            _v = VFFSL(SL,"tier",True) # $tier
            if _v is not None: write(_filter(_v, rawExpr='$tier')) # from line 64, col 23.
            write('</option>\n')
        write('''</select>
</div>
...
<select id="kw_release">
<option value="Any" selected="selected">Any</option>
''')
        for rel in VFFSL(SL,"softReleases",True):
            write('<option value="')
            _v = VFFSL(SL,"rel",True) # $rel
            if _v is not None: write(_filter(_v, rawExpr='$rel')) # from line 83, col 16.
            write('">')
            _v = VFFSL(SL,"rel",True) # $rel
            if _v is not None: write(_filter(_v, rawExpr='$rel')) # from line 83, col 22.
            write('</option>\n')
        write('''</select>
</div>
...
<option value="Any" selected="selected">Any</option>
''')
        for prim in VFFSL(SL,"primDatasets",True):
            write('<option value="')
            _v = VFFSL(SL,"prim",True) # $prim
            if _v is not None: write(_filter(_v, rawExpr='$prim')) # from line 102, col 16.
            write('">')
            _v = VFFSL(SL,"prim",True) # $prim
            if _v is not None: write(_filter(_v, rawExpr='$prim')) # from line 102, col 23.
            write('</option>\n')
        write('''</select>
</div>
...
''')
        for site in VFFSL(SL,"siteList",True):
            ...
            if _v is not None: write(_filter(_v, rawExpr='$site')) # from line 121, col 9.
            write('</option>\n')
        write('''</select>
</div>
