...
__CHEETAH_genTime__ = 'Thu Mar 15 12:44:14 2007'
__CHEETAH_srcLastModified__ = 'Sat Mar  3 11:28:55 2007'
__CHEETAH_src__ = 'Templates/tmpl/templateDBSInstanceDesc.tmpl'
__CHEETAH_version__ = '2.0b5'

##################################################
## CLASSES

class templateDBSInstanceDesc(Template):
...
''')
    ...
    _mainCheetahMethod_for_templateDBSInstanceDesc= 'respond'
if not hasattr(templateDBSInstanceDesc, '_initCheetahAttributes'):
    templateClass = getattr(templateDBSInstanceDesc, '_CHEETAH_templateClass', Template)
    templateClass._assignRequiredMethodsToClass(templateDBSInstanceDesc)
...
if __name__ == '__main__':
    ...
    CmdLineIface(templateObj=templateDBSInstanceDesc()).run()
