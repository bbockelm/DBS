...
__CHEETAH_genTime__ = 'Thu Mar 15 12:44:42 2007'
__CHEETAH_srcLastModified__ = 'Wed Mar 14 23:08:47 2007'
...
''')
        ...
        for section in VFFSL(SL,"sectionList",True)[1:]:
            ...
            if _v is not None: write(_filter(_v, rawExpr='$section')) # from line 20, col 16.
            write('">')
            _v = VFFSL(SL,"section",True) # $section
            if _v is not None: write(_filter(_v, rawExpr='$section')) # from line 20, col 26.
            write('</option>\n')
        write('''</select>
</td>
...
<div id="divSectionTables_''')
        ...
        for table in VFFSL(SL,"tableList",True):
            ...
            if _v is not None: write(_filter(_v, rawExpr='$table')) # from line 29, col 16.
            write('">')
            _v = VFFSL(SL,"table",True) # $table
            if _v is not None: write(_filter(_v, rawExpr='$table')) # from line 29, col 24.
            write('</option>\n')
        write('''</select>
</div>
</td>
...
<a href="javascript:ajaxMakeLine(''')
        ...
        write(')"><img src="images/plus.png" alt="add" style="border:none" /></a>\n<a href="javascript:ClearTag(\'makeMenu_')
        _v = VFFSL(SL,"id",True) # $id
        if _v is not None: write(_filter(_v, rawExpr='$id')) # from line 57, col 40.
        write('''\')"><img src="images/minus.png" alt="remove" style="border:none" /></a>
</td>
</tr>
</table>
</div>
