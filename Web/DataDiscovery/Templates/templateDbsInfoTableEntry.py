...
__CHEETAH_srcLastModified__ = 'Tue Mar 13 16:09:00 2007'
...
class templateDbsInfoTableEntry(Template):
    ...
    def respond(self, trans=None):
        ...
        for dbsDict in VFFSL(SL,"dbsList",True):
            ...
            sName = VFN(VFFSL(SL,"bName",True),"replace",False)('#','<br />#')
            ...
            if _v is not None: write(_filter(_v, rawExpr='$sName')) # from line 8, col 31.
            write('</td>\n<td align="right">')
            _v = VFFSL(SL,"dbsDict",True)['NumberOfEvents'] # $dbsDict['NumberOfEvents']
            if _v is not None: write(_filter(_v, rawExpr="$dbsDict['NumberOfEvents']")) # from line 9, col 19.
            write('</td>\n<td align="right">')
            _v = VFFSL(SL,"dbsDict",True)['NumberOfFiles'] # $dbsDict['NumberOfFiles']
            if _v is not None: write(_filter(_v, rawExpr="$dbsDict['NumberOfFiles']")) # from line 10, col 19.
            write('</td>\n<td align="right">')
            _v = VFFSL(SL,"colorSizeHTMLFormat",False)(VFFSL(SL,"dbsDict",True)['BlockSize']) # $colorSizeHTMLFormat($dbsDict['BlockSize'])
            if _v is not None: write(_filter(_v, rawExpr="$colorSizeHTMLFormat($dbsDict['BlockSize'])")) # from line 11, col 19.
            ...
            write('\',900)">txt</a>,\n<a href="javascript:popUp(\'')
            _v = VFFSL(SL,"host",True) # $host
            if _v is not None: write(_filter(_v, rawExpr='$host')) # from line 15, col 28.
            write('/getLFNlist?dbsInst=')
            _v = VFFSL(SL,"dbsInst",True) # $dbsInst
            if _v is not None: write(_filter(_v, rawExpr='$dbsInst')) # from line 15, col 53.
            write('&amp;blockName=')
            _v = VFFSL(SL,"bName",True) # $bName
            if _v is not None: write(_filter(_v, rawExpr='$bName')) # from line 15, col 76.
            ...
            if _v is not None: write(_filter(_v, rawExpr="$dbsDict['CreatedBy']")) # from line 22, col 19.
            write('</td>\n<td align="center">')
            _v = VFFSL(SL,"dbsDict",True)['CreationDate'] # $dbsDict['CreationDate']
            if _v is not None: write(_filter(_v, rawExpr="$dbsDict['CreationDate']")) # from line 23, col 20.
            write('</td>\n<td align="right">')
            _v = VFFSL(SL,"dbsDict",True)['LastModifiedBy'] # $dbsDict['LastModifiedBy']
            if _v is not None: write(_filter(_v, rawExpr="$dbsDict['LastModifiedBy']")) # from line 24, col 19.
            write('</td>\n<td align="center">')
            _v = VFFSL(SL,"dbsDict",True)['LastModificationDate'] # $dbsDict['LastModificationDate']
            if _v is not None: write(_filter(_v, rawExpr="$dbsDict['LastModificationDate']")) # from line 25, col 20.
            write('</td>\n</tr>\n')
