...
__CHEETAH_srcLastModified__ = 'Sun Mar  4 15:25:21 2007'
...
''')
  ...
  <li id="DBSinfo_Menu">
    <a href="javascript:showMenu('DBSinfo');getDbsInfo(\'''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='$dbsGlobal')) # from line 50, col 57.
            write("',")
            _v = VFFSL(SL,"dbsNames",True) # $dbsNames
            if _v is not None: write(_filter(_v, rawExpr='$dbsNames')) # from line 50, col 69.
            ...
            for iName in VFFSL(SL,"dbsNames",True):
                ...
                if _v is not None: write(_filter(_v, rawExpr='$name')) # from line 54, col 47.
                write('"><a href="javascript:getDbsInfo(\'')
                _v = VFFSL(SL,"iName",True) # $iName
                if _v is not None: write(_filter(_v, rawExpr='$iName')) # from line 54, col 86.
                write("',")
                _v = VFFSL(SL,"dbsNames",True) # $dbsNames
                if _v is not None: write(_filter(_v, rawExpr='$dbsNames')) # from line 54, col 94.
                write(');">')
                _v = VFFSL(SL,"iName",True) # $iName
                if _v is not None: write(_filter(_v, rawExpr='$iName')) # from line 54, col 107.
                write('</a></td></tr>\n')
            write('      </table>       \n  </li>\n')
        write('\n')
        if VFFSL(SL,"userMode",True)!="dbsExpert":
...
''')
        ...
        write('\n  <li id="History_Menu">\n')
        hList = ['user','search']
        hDict = {'user':'Session','search':'Search'}
        write('    <a href="javascript:showMenu(\'History\');showHistoryMenu(\'')
        _v = VFFSL(SL,"hList",True)[0] # $hList[0]
        if _v is not None: write(_filter(_v, rawExpr='$hList[0]')) # from line 95, col 62.
        write("',")
        _v = VFFSL(SL,"hList",True) # $hList
        if _v is not None: write(_filter(_v, rawExpr='$hList')) # from line 95, col 73.
        write(');ajaxGetHistory();">History</a>\n      <table id="history_table" class="hide">\n')
        for name in VFFSL(SL,"hList",True):
            write('          <tr><td>&#187;</td><td id="_')
            _v = VFFSL(SL,"name",True) # ${name}
            if _v is not None: write(_filter(_v, rawExpr='${name}')) # from line 98, col 40.
            write('History"><a href="javascript:showHistoryMenu(\'')
            _v = VFFSL(SL,"name",True) # $name
            if _v is not None: write(_filter(_v, rawExpr='$name')) # from line 98, col 93.
            write("',")
            _v = VFFSL(SL,"hList",True) # $hList
            if _v is not None: write(_filter(_v, rawExpr='$hList')) # from line 98, col 100.
            write(');AdjustToDate()">')
            _v = VFFSL(SL,"hDict",True)[VFFSL(SL,"name",True)] # $hDict[$name]
            if _v is not None: write(_filter(_v, rawExpr='$hDict[$name]')) # from line 98, col 124.
            write('</a></td></tr>\n')
        write('''      </table>       
  </li>
  ...
  <li id="Hide_Menu">
    <a href="javascript:HidePanel(\'''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$host')) # from line 110, col 36.
        write('''\')">Hide panel</a>
  </li>
  ...
  <li class="plain0">
    <em class="tiny_purple_on_gray">Tip: ''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$tip')) # from line 116, col 42.
        write('''</em>
  </li>
</ul>
</div>
...
''')
        if VFFSL(SL,"userMode",True):
            ...
            if _v is not None: write(_filter(_v, rawExpr='$userNavigator')) # from line 137, col 1.
            write('\n')
        else:
            _v = VFFSL(SL,"navigatorForm",True) # $navigatorForm
            if _v is not None: write(_filter(_v, rawExpr='$navigatorForm')) # from line 139, col 1.
            write('\n')
        write('''</td>
</tr>
</table>
...
''')
        menuArr = ['sessionHistory','allHistory']
        write('<table id="userHistory_info" class="show_table" cellspacing="1" width="50%">\n<tr>\n<td class="td_menu_white_box" align="center" id="_sessionHistory"><a href="javascript:showResMenu(\'sessionHistory\',')
        _v = VFFSL(SL,"menuArr",True) # $menuArr
        if _v is not None: write(_filter(_v, rawExpr='$menuArr')) # from line 331, col 116.
        write(')">Current session</a></td>\n<td class="td_menu_gray_box" align="center" id="_allHistory"><a href="javascript:showResMenu(\'allHistory\',')
        _v = VFFSL(SL,"menuArr",True) # $menuArr
        if _v is not None: write(_filter(_v, rawExpr='$menuArr')) # from line 332, col 107.
        write(''')">Last 100</a></td>
</tr>
</table>
...
''')
        for year in xrange(2006,2016):
            ...
            if _v is not None: write(_filter(_v, rawExpr='$year')) # from line 401, col 22.
            write('">')
            _v = VFFSL(SL,"year",True) # $year
            if _v is not None: write(_filter(_v, rawExpr='$year')) # from line 401, col 29.
            write('</option>\n')
        write('      </select>\n')
        ...
        for month in VFFSL(SL,"mArr",True):
            ...
            if _v is not None: write(_filter(_v, rawExpr='$month')) # from line 407, col 22.
            write('">')
            _v = VFFSL(SL,"month",True) # $month
            if _v is not None: write(_filter(_v, rawExpr='$month')) # from line 407, col 30.
            write('</option>\n')
        write('''      </select>
      </td>
      <td>
...
''')
        for year in xrange(2006,2016):
            write('      <option value="')
            _v = VFFSL(SL,"year",True) # $year
            if _v is not None: write(_filter(_v, rawExpr='$year')) # from line 417, col 22.
            write('">')
            _v = VFFSL(SL,"year",True) # $year
            if _v is not None: write(_filter(_v, rawExpr='$year')) # from line 417, col 29.
            write('</option>\n')
        write('      </select>\n')
        mArr = ['Jan','Feb','Mar','May','Apr','Jun','Jul','Aug','Sep','Oct','Nov','Dec']
        ...
        for month in VFFSL(SL,"mArr",True):
            write('      <option value="')
            _v = VFFSL(SL,"month",True) # $month
            if _v is not None: write(_filter(_v, rawExpr='$month')) # from line 423, col 22.
            write('">')
            _v = VFFSL(SL,"month",True) # $month
            if _v is not None: write(_filter(_v, rawExpr='$month')) # from line 423, col 30.
            write('</option>\n')
        write('''      </select>
      </td>
      <td>
...
<td class="td_menu_white_box" align="center" id="_help_intro"><a href="javascript:showResMenu('help_intro',''')
        _v = VFFSL(SL,"menuArr",True) # $menuArr
        if _v is not None: write(_filter(_v, rawExpr='$menuArr')) # from line 460, col 108.
        ...
        _v = VFFSL(SL,"menuArr",True) # $menuArr
        if _v is not None: write(_filter(_v, rawExpr='$menuArr')) # from line 461, col 113.
        ...
        _v = VFFSL(SL,"menuArr",True) # $menuArr
        if _v is not None: write(_filter(_v, rawExpr='$menuArr')) # from line 462, col 115.
        ...
        _v = VFFSL(SL,"menuArr",True) # $menuArr
        if _v is not None: write(_filter(_v, rawExpr='$menuArr')) # from line 463, col 113.
        write(')">Feedback</a></td>\n<td class="td_menu_gray_box" align="center" id="_help_refs"><a href="javascript:showResMenu(\'help_refs\',')
        _v = VFFSL(SL,"menuArr",True) # $menuArr
        if _v is not None: write(_filter(_v, rawExpr='$menuArr')) # from line 464, col 105.
...
<div id="help_glossary" class="hide"><div class="div_scroll">''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$glossary')) # from line 514, col 62.
        write('''</div></div>
...
<div class="div_scroll">
          <table>
              ...
              <td><a href="''')
        _v = VFFSL(SL,"host",True) # $host
        if _v is not None: write(_filter(_v, rawExpr='$host')) # from line 542, col 28.
        write('''/Documentation/index.html">API doc</a>
              ...
              <td><a href="''')
        _v = VFFSL(SL,"host",True) # $host
        if _v is not None: write(_filter(_v, rawExpr='$host')) # from line 547, col 28.
...
''')
        for dbs in VFFSL(SL,"dbsList",True):
            ...
            if _v is not None: write(_filter(_v, rawExpr='$dbs')) # from line 645, col 18.
            write('</option>\n')
        write('''         </select>
         </td>
         </tr>
...
''')
        for table in VFFSL(SL,"dbsTables",True):
            ...
            if _v is not None: write(_filter(_v, rawExpr='$table')) # from line 659, col 18.
            write('</option>\n')
        write('''         </select>
         </td>
         <td>
...
''')
        ...
        write('\n')
        if VFFSL(SL,"userMode",True):
            write('''registerAjaxUserMenuCalls();
resetPhysGroups();
ajaxGetKWFields();
''')
        write('\n</script>\n')
