...
__CHEETAH_srcLastModified__ = 'Sun Mar  4 13:04:33 2007'
...
<td><a href="''')
            ...
            write('">Lumis</a></td>\n<td>|</td>\n<td><a href="javascript:ajaxGetLumis(\'')
            _v = VFFSL(SL,"dbsInst",True) # $dbsInst
            if _v is not None: write(_filter(_v, rawExpr='$dbsInst')) # from line 33, col 39.
            write("','")
            _v = VFFSL(SL,"name",True) # $name
            if _v is not None: write(_filter(_v, rawExpr='$name')) # from line 33, col 50.
            write('\')">Lumis2</a></td>\n')
            # 
            # <td>|</td>
