...
{label: "Runs", link: "_siteSearch?userMode=expert", title: "Run search: run-based search"},
...
//{title: "Run Manager view of DBS", link: "_runs?userMode=expert", label: "RunMgr", position: "right"}
    ]
}
