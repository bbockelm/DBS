...
DROP TABLE FileAlgoMap CASCADE CONSTRAINTS;
DROP TABLE FileLumi CASCADE CONSTRAINTS;
DROP TABLE FileParentage CASCADE CONSTRAINTS;
DROP TABLE FileTier CASCADE CONSTRAINTS;
DROP TABLE AnalysisDatasetLumi CASCADE CONSTRAINTS;
DROP TABLE Files CASCADE CONSTRAINTS;
DROP TABLE AnalysisDataset CASCADE CONSTRAINTS;
DROP TABLE ProcAlgoMap CASCADE CONSTRAINTS;
DROP TABLE DatasetParentage CASCADE CONSTRAINTS;
DROP TABLE ProcDSTier CASCADE CONSTRAINTS;
DROP TABLE ProcDSRuns CASCADE CONSTRAINTS;
DROP TABLE Block CASCADE CONSTRAINTS;
DROP TABLE ProcessedDataset CASCADE CONSTRAINTS;
DROP TABLE PrimaryDataset CASCADE CONSTRAINTS;
DROP TABLE PrimaryDatasetDescription CASCADE CONSTRAINTS;
DROP TABLE AlgorithmConfig CASCADE CONSTRAINTS;
DROP TABLE OtherDescription CASCADE CONSTRAINTS;
DROP TABLE MCDescription CASCADE CONSTRAINTS;
DROP TABLE TriggerPathDescription CASCADE CONSTRAINTS;
DROP TABLE ParameterBinding CASCADE CONSTRAINTS;
DROP TABLE QueryableParameterSet CASCADE CONSTRAINTS;
DROP TABLE AppExecutable CASCADE CONSTRAINTS;
DROP TABLE AppVersion CASCADE CONSTRAINTS;
DROP TABLE AppFamily CASCADE CONSTRAINTS;
DROP TABLE TimeLog CASCADE CONSTRAINTS;
DROP TABLE Description CASCADE CONSTRAINTS;
DROP TABLE Type CASCADE CONSTRAINTS;
DROP TABLE Status CASCADE CONSTRAINTS;
DROP TABLE LumiSection CASCADE CONSTRAINTS;
DROP TABLE DataTier CASCADE CONSTRAINTS;
DROP TABLE Runs CASCADE CONSTRAINTS;
DROP TABLE SchemaVersion CASCADE CONSTRAINTS;
DROP TABLE PhysicsGroup CASCADE CONSTRAINTS;
DROP TABLE AssignedRole CASCADE CONSTRAINTS;
