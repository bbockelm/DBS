...
-- INDEXES
--YG. All index on DESCRIPTION (varchar2 1000) should be removed. July 09, 07 
...
--YG. Why is it commented out here? It is in 105 deployable script.July/07/07
--YG. Comfirmed with Anzar.It should be removed from 105 deployable scripts. 
...
--YG. ORA-01758: table must be empty to add mandatory (NOT NULL) column
ALTER TABLE ANALYSISDATASET ADD (VERSION INTEGER NOT NULL);
ALTER TABLE ANALYSISDATASET ADD (PATH VARCHAR2(500) NOT NULL);
--ALTER TABLE ANALYSISDATASET ADD (PATH VARCHAR2(500);
--ALTER TABLE ANALYSISDATASET ADD (VERSION INTEGER);
--YG. Then one has to add data into the path, after that try to change it to NOT NULL.
...
--YG. Got Oracle error when set to null
...
--YG. Change to below:
ALTER TABLE ANALYSISDATASET DROP (ANNOTATION, PARENT);
