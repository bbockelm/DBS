-- DDL file generated by ./generate_oracle_deployable.sh on 05152007170914
-- ====================================================
-- ====================================================
-- ====================================================
...
INSERT INTO SchemaVersion(SCHEMAVERSION, CREATIONDATE) values ('DBS_1_0_3', (select (sysdate - to_date('19700101','YYYYMMDD')) * 86400 from dual));
