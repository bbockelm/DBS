-- DDL file generated by ./generate_oracle_deployable.sh on 08152007164929
-- ====================================================
-- ====================================================
-- ====================================================
...
INSERT INTO SchemaVersion(SCHEMAVERSION, INSTANCENAME, CREATIONDATE) values ('DBS_1_0_5', 'LOCAL', (select (sysdate - to_date('19700101','YYYYMMDD')) * 86400 from dual));
