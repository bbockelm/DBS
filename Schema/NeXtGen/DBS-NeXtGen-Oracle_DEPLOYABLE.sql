-- DDL file generated by ./generate_oracle_deployable.sh on 03272007120154
-- ====================================================
-- ====================================================
-- ====================================================
...
PROMPT creating sequence seq_filebranch ;
...
PROMPT AUTO INC TRIGGER FOR Trigger for Table: filebranch
...
PROMPT LastModified Time Stamp Trigger for Table: filebranch
...
INSERT INTO AnalysisDSStatus (Status, CREATIONDATE) VALUES ('NEW', SYSTIMESTAMP);
INSERT INTO FileStatus (Status, CREATIONDATE) VALUES ('VALID', SYSTIMESTAMP);
INSERT INTO FileStatus (Status, CREATIONDATE) VALUES ('INVALID', SYSTIMESTAMP);
INSERT INTO FileStatus (Status, CREATIONDATE) VALUES ('MERGED', SYSTIMESTAMP);
INSERT INTO FileStatus (Status, CREATIONDATE) VALUES ('IMPORTED', SYSTIMESTAMP);
INSERT INTO FileStatus (Status, CREATIONDATE) VALUES ('EXPORTED', SYSTIMESTAMP);
INSERT INTO ProcDSStatus (Status, CREATIONDATE) VALUES ('VALID', SYSTIMESTAMP);
INSERT INTO ProcDSStatus (Status, CREATIONDATE) VALUES ('INVALID', SYSTIMESTAMP);
INSERT INTO ProcDSStatus (Status, CREATIONDATE) VALUES ('EXPORTED', SYSTIMESTAMP);
INSERT INTO ProcDSStatus (Status, CREATIONDATE) VALUES ('IMPORTED', SYSTIMESTAMP);
INSERT INTO FileType(Type, CREATIONDATE) VALUES ('EDM', SYSTIMESTAMP) ;
INSERT INTO AnalysisDSType(Type, CREATIONDATE) VALUES ('TEST', SYSTIMESTAMP);
INSERT INTO PrimaryDSType  (Type, CreationDate) VALUES ('TEST', SYSTIMESTAMP);
INSERT INTO PrimaryDSType  (Type, CreationDate) VALUES ('MC', SYSTIMESTAMP);
INSERT INTO PrimaryDSType  (Type, CreationDate) VALUES ('COSMIC', SYSTIMESTAMP);
INSERT INTO PrimaryDSType  (Type, CreationDate) VALUES ('ALIGN', SYSTIMESTAMP);
INSERT INTO PrimaryDSType  (Type, CreationDate) VALUES ('CALIB', SYSTIMESTAMP);
INSERT INTO PrimaryDSType  (Type, CreationDate) VALUES ('RAW', SYSTIMESTAMP);
...
INSERT INTO DataTierOrder(DataTierOrder, Description, CREATIONDATE) VALUES ('GEN', 'Generator output, four vectors and vertices in vacuum. For example, pythia events HepMCProduct', SYSTIMESTAMP);
INSERT INTO DataTierOrder(DataTierOrder, Description, CREATIONDATE) VALUES ('SIM', 'Simulated output from GEANT/OSCAR processing of GEN data  PSimHitContainer, EmbdSimVertexContainer, PCaloHitContainer, CrossingFrame', SYSTIMESTAMP);
INSERT INTO DataTierOrder(DataTierOrder, Description, CREATIONDATE) VALUES ('DIGI', 'Digitixed output from the various Digitizers that act on the SIM data    EBDigiCollection, HBHEDigiCollection, HFDigiCollection, StripDigiCollection, CSCStripDigiCollection, CSCWireDigiCollection', SYSTIMESTAMP);
INSERT INTO DataTierOrder(DataTierOrder, Description, CREATIONDATE) VALUES ('RECO', 'Reconstructed products produced from either real data or DIGI data', SYSTIMESTAMP);
INSERT INTO DataTierOrder(DataTierOrder, Description, CREATIONDATE) VALUES ('AOD', 'Analysis Object Data products TBA', SYSTIMESTAMP);
INSERT INTO DataTierOrder(DataTierOrder, Description, CREATIONDATE) VALUES ('RAW', 'Raw detector output from the HLT system', SYSTIMESTAMP);
INSERT INTO DataTierOrder(DataTierOrder, Description, CREATIONDATE) VALUES ('ALCARECO', 'IS ITS A TIER ? TBA', SYSTIMESTAMP);
INSERT INTO DataTierOrder(DataTierOrder, Description, CREATIONDATE) VALUES ('USER', 'Things that users make afte AOD. The analysis equivalent of the kitchen sink TBA', SYSTIMESTAMP);
INSERT INTO DataTierOrder(DataTierOrder, Description, CREATIONDATE) VALUES ('GEN-SIM', 'Generator output, four vectors and vertices in vacuum. For example, pythia events HepMCProduct', SYSTIMESTAMP);
INSERT INTO DataTierOrder(DataTierOrder, Description, CREATIONDATE) VALUES ('GEN-SIM-DIGI', 'Generator output, four vectors and vertices in vacuum. For example, pythia events HepMCProduct', SYSTIMESTAMP);
INSERT INTO DataTierOrder(DataTierOrder, Description, CREATIONDATE) VALUES ('GEN-SIM-DIGI-RECO', 'Generator output, four vectors and vertices in vacuum. For example, pythia events HepMCProduct', SYSTIMESTAMP);
INSERT INTO DataTierOrder(DataTierOrder, Description, CREATIONDATE) VALUES ('FEVT', 'IS ITS A TIER', SYSTIMESTAMP);
INSERT INTO DataTier (Name, CreationDate) VALUES ('RAW', SYSTIMESTAMP);
INSERT INTO DataTier (Name, CreationDate) VALUES ('FEVT', SYSTIMESTAMP);
...
INSERT INTO DataTier (Name, CreationDate) VALUES ('AOD', SYSTIMESTAMP);
INSERT INTO PhysicsGroup (PhysicsGroupName, CreationDate) VALUES ('None', SYSTIMESTAMP);
INSERT INTO PhysicsGroup (PhysicsGroupName, CreationDate) VALUES ('Individual', SYSTIMESTAMP);
INSERT INTO PhysicsGroup (PhysicsGroupName, CreationDate) VALUES ('Higgs', SYSTIMESTAMP);
INSERT INTO PhysicsGroup (PhysicsGroupName, CreationDate) VALUES ('SUSY', SYSTIMESTAMP);
INSERT INTO PhysicsGroup (PhysicsGroupName, CreationDate) VALUES ('BSM', SYSTIMESTAMP);
INSERT INTO PhysicsGroup (PhysicsGroupName, CreationDate) VALUES ('EWK', SYSTIMESTAMP);
INSERT INTO PhysicsGroup (PhysicsGroupName, CreationDate) VALUES ('Top', SYSTIMESTAMP);
INSERT INTO PhysicsGroup (PhysicsGroupName, CreationDate) VALUES ('QCD', SYSTIMESTAMP);
INSERT INTO PhysicsGroup (PhysicsGroupName, CreationDate) VALUES ('Diffraction', SYSTIMESTAMP);
INSERT INTO PhysicsGroup (PhysicsGroupName, CreationDate) VALUES ('Online Selection', SYSTIMESTAMP);
INSERT INTO PhysicsGroup (PhysicsGroupName, CreationDate) VALUES ('B-physics', SYSTIMESTAMP);
INSERT INTO PhysicsGroup (PhysicsGroupName, CreationDate) VALUES ('Muons', SYSTIMESTAMP);
INSERT INTO PhysicsGroup (PhysicsGroupName, CreationDate) VALUES ('Egamma', SYSTIMESTAMP);
INSERT INTO PhysicsGroup (PhysicsGroupName, CreationDate) VALUES ('JetMet', SYSTIMESTAMP);
INSERT INTO PhysicsGroup (PhysicsGroupName, CreationDate) VALUES ('E-flow', SYSTIMESTAMP);
INSERT INTO PhysicsGroup (PhysicsGroupName, CreationDate) VALUES ('tau', SYSTIMESTAMP);
INSERT INTO PhysicsGroup (PhysicsGroupName, CreationDate) VALUES ('B-tagging', SYSTIMESTAMP);
commit;
