-- DDL file generated by ./generate_oracle_deployable.sh on 11172006145339
-- ====================================================
-- ====================================================
-- ====================================================
REM ======================================================================
...
create index ix_person_distinguishedname on Person (DistinguishedName);
create index ix_timelog_action on TimeLog (Action);
...
-- ====================================================
-- AUTO INC TRIGGER FOR status.ID using SEQ seq_status

 CREATE OR REPLACE TRIGGER status_TRIG before insert on status    for each row begin     if inserting then       if :NEW.ID is null then          select seq_status.nextval into :NEW.ID from dual;       end if;    end if; end;
/

-- ====================================================
-- AUTO INC TRIGGER FOR type.ID using SEQ seq_type

 CREATE OR REPLACE TRIGGER type_TRIG before insert on type    for each row begin     if inserting then       if :NEW.ID is null then          select seq_type.nextval into :NEW.ID from dual;       end if;    end if; end;
/
...
CREATE OR REPLACE TRIGGER TR_TS_person BEFORE INSERT OR UPDATE ON person
FOR EACH ROW
BEGIN
...
CREATE OR REPLACE TRIGGER TR_TS_role BEFORE INSERT OR UPDATE ON role
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_assignedrole BEFORE INSERT OR UPDATE ON assignedrole
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_physicsgroup BEFORE INSERT OR UPDATE ON physicsgroup
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_schemaversion BEFORE INSERT OR UPDATE ON schemaversion
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_runs BEFORE INSERT OR UPDATE ON runs
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_datatier BEFORE INSERT OR UPDATE ON datatier
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_lumisection BEFORE INSERT OR UPDATE ON lumisection
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_status BEFORE INSERT OR UPDATE ON status
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_type BEFORE INSERT OR UPDATE ON type
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_description BEFORE INSERT OR UPDATE ON description
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_timelog BEFORE INSERT OR UPDATE ON timelog
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_analysisdsstatus BEFORE INSERT OR UPDATE ON analysisdsstatus
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_primarydstype BEFORE INSERT OR UPDATE ON primarydstype
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_appfamily BEFORE INSERT OR UPDATE ON appfamily
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_appversion BEFORE INSERT OR UPDATE ON appversion
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_appexecutable BEFORE INSERT OR UPDATE ON appexecutable
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_queryableparameterset BEFORE INSERT OR UPDATE ON queryableparameterset
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_parameterbinding BEFORE INSERT OR UPDATE ON parameterbinding
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_triggerpathdescription BEFORE INSERT OR UPDATE ON triggerpathdescription
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_mcdescription BEFORE INSERT OR UPDATE ON mcdescription
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_otherdescription BEFORE INSERT OR UPDATE ON otherdescription
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_filestatus BEFORE INSERT OR UPDATE ON filestatus
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_filetype BEFORE INSERT OR UPDATE ON filetype
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_procdsstatus BEFORE INSERT OR UPDATE ON procdsstatus
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_primarydataset BEFORE INSERT OR UPDATE ON primarydataset
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_processeddataset BEFORE INSERT OR UPDATE ON processeddataset
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_block BEFORE INSERT OR UPDATE ON block
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_procdsruns BEFORE INSERT OR UPDATE ON procdsruns
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_procdstier BEFORE INSERT OR UPDATE ON procdstier
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_datasetparentage BEFORE INSERT OR UPDATE ON datasetparentage
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_procalgo BEFORE INSERT OR UPDATE ON procalgo
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_analysisdataset BEFORE INSERT OR UPDATE ON analysisdataset
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_files BEFORE INSERT OR UPDATE ON files
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_analysisdatasetlumi BEFORE INSERT OR UPDATE ON analysisdatasetlumi
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_filetier BEFORE INSERT OR UPDATE ON filetier
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_fileparentage BEFORE INSERT OR UPDATE ON fileparentage
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_filelumi BEFORE INSERT OR UPDATE ON filelumi
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TR_TS_filealgo BEFORE INSERT OR UPDATE ON filealgo
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRTSstatus BEFORE INSERT OR UPDATE ON status
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRTStype BEFORE INSERT OR UPDATE ON type
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
