-- DDL file generated by ./deploy_oracle.sh on 11162006155651
-- ====================================================
-- ====================================================
-- ====================================================
REM ======================================================================
...
create index ix_physicsgroup_physicsgroupname on PhysicsGroup (PhysicsGroupName);
create index ix_runs_runnumber on Runs (RunNumber);
create index ix_runs_storenumber on Runs (StoreNumber);
create index ix_datatier_name on DataTier (Name);
create index ix_lumisection_lumisectionnumber on LumiSection (LumiSectionNumber);
create index ix_timelog_action on TimeLog (Action);
create index ix_appfamily_familyname on AppFamily (FamilyName);
create index ix_appversion_version on AppVersion (Version);
create index ix_appexecutable_executablename on AppExecutable (ExecutableName);
create index ix_queryableparameterset_hash on QueryableParameterSet (Hash);
create index ix_primarydataset_name on PrimaryDataset (Name);
