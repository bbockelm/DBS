-- DDL file generated by ./generate_oracle_deployable.sh on 01122007161639
-- ====================================================
-- ====================================================
-- ====================================================
REM ======================================================================
...
CREATE OR REPLACE TRIGGER TRTSbranch BEFORE INSERT OR UPDATE ON branch
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRTSanalysisdsdef BEFORE INSERT OR UPDATE ON analysisdsdef
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRTSfilebranch BEFORE INSERT OR UPDATE ON filebranch
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
CREATE OR REPLACE TRIGGER TRTSprocdsparent BEFORE INSERT OR UPDATE ON procdsparent
FOR EACH ROW
BEGIN
  :NEW.LASTMODIFICATIONDATE := SYSTIMESTAMP;
END;
...
INSERT INTO SchemaVersion(SCHEMAVERSION, CREATIONDATE) values ('v00_00_04', SYSTIMESTAMP);
