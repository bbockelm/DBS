-- DDL file generated by ./generate_oracle_deployable.sh on 03292007123825
-- ====================================================
-- ====================================================
-- ====================================================
...
INSERT INTO SchemaVersion(SCHEMAVERSION, CREATIONDATE) values ('v00_00_06', (select (sysdate - to_date('19700101','YYYYMMDD')) * 86400 from dual));
...
INSERT INTO PhysicsGroup (PhysicsGroupName, CreationDate) VALUES ('None', (select (sysdate - to_date('19700101','YYYYMMDD')) * 86400 from dual));
...
INSERT INTO PhysicsGroup (PhysicsGroupName, CreationDate) VALUES ('SUSY', (select (sysdate - to_date('19700101','YYYYMMDD')) * 86400 from dual));
INSERT INTO PhysicsGroup (PhysicsGroupName, CreationDate) VALUES ('BSM', (select (sysdate - to_date('19700101','YYYYMMDD')) * 86400 from dual));
