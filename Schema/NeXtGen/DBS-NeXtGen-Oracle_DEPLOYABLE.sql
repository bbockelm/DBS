-- DDL file generated by ./generate_oracle_deployable.sh on 06192007144315
-- ====================================================
-- ====================================================
-- ====================================================
...
INSERT INTO SubSystem (Name, Parent, CreationDate) VALUES ('HCAL', 'CMS',(select (sysdate - to_date('19700101','YYYYMMDD')) * 86400 from dual));
INSERT INTO SubSystem (Name, Parent, CreationDate) VALUES ('HCAL+','HCAL', (select (sysdate - to_date('19700101','YYYYMMDD')) * 86400 from dual));
INSERT INTO SubSystem (Name, Parent, CreationDate) VALUES ('HCAL-','HCAL', (select (sysdate - to_date('19700101','YYYYMMDD')) * 86400 from dual));
INSERT INTO SubSystem (Name, Parent, CreationDate) VALUES ('ECAL', 'CMS', (select (sysdate - to_date('19700101','YYYYMMDD')) * 86400 from dual));
INSERT INTO SubSystem (Name, Parent, CreationDate) VALUES ('ECAL+','ECAL', (select (sysdate - to_date('19700101','YYYYMMDD')) * 86400 from dual));
INSERT INTO SubSystem (Name, Parent, CreationDate) VALUES ('ECAL-','ECAL', (select (sysdate - to_date('19700101','YYYYMMDD')) * 86400 from dual));
INSERT INTO SubSystem (Name, Parent, CreationDate) VALUES ('NOSUB','CMS',(select (sysdate - to_date('19700101','YYYYMMDD')) * 86400 from dual));
