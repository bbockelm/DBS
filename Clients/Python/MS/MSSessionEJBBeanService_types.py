...
##############################
# targetNamespace
# http://session.ejb.gov.fnal/
##############################

class ns0:
    targetNamespace = "http://session.ejb.gov.fnal/"

    class addRequest_Def(ZSI.TCcompound.ComplexType, TypeDefinition):
        schema = "http://session.ejb.gov.fnal/"
    ...
    class addRequestResponse_Def(ZSI.TCcompound.ComplexType, TypeDefinition):
        ...
        def __init__(self, pname, ofwhat=(), attributes=None, extend=False, restrict=False, **kw):
            ...
            TClist = [GTD("http://session.ejb.gov.fnal/","request",lazy=False)(pname="return", aname="_return", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded"))]
            self.attribute_typecode_dict = attributes or {}
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
            ZSI.TCcompound.ComplexType.__init__(self, None, TClist, pname=pname, inorder=0, **kw)
    ...
    class request_Def(ZSI.TCcompound.ComplexType, TypeDefinition):
        ...
        def __init__(self, pname, ofwhat=(), attributes=None, extend=False, restrict=False, **kw):
            ...
            TClist = [ZSI.TC.String(pname="detail", aname="_detail", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), GTD("http://session.ejb.gov.fnal/","dbsurl",lazy=False)(pname="dstUrl", aname="_dstUrl", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TCnumbers.Ilong(pname="id", aname="_id", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="notify", aname="_notify", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="path", aname="_path", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), GTD("http://session.ejb.gov.fnal/","person",lazy=False)(pname="person", aname="_person", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TCnumbers.Iint(pname="progress", aname="_progress", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), GTD("http://session.ejb.gov.fnal/","dbsurl",lazy=False)(pname="srcUrl", aname="_srcUrl", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="status", aname="_status", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="withForce", aname="_withForce", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="withParents", aname="_withParents", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded"))]
            self.attribute_typecode_dict = attributes or {}
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
            ZSI.TCcompound.ComplexType.__init__(self, None, TClist, pname=pname, inorder=0, **kw)
    ...
    class getRequestByStatusResponse_Def(ZSI.TCcompound.ComplexType, TypeDefinition):
        ...
        def __init__(self, pname, ofwhat=(), attributes=None, extend=False, restrict=False, **kw):
            ...
            TClist = [GTD("http://session.ejb.gov.fnal/","request",lazy=False)(pname="return", aname="_return", minOccurs=0, maxOccurs="unbounded", nillable=False, typed=False, encoded=kw.get("encoded"))]
            self.attribute_typecode_dict = attributes or {}
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
            ZSI.TCcompound.ComplexType.__init__(self, None, TClist, pname=pname, inorder=0, **kw)
    ...
    class Exception_Dec(ElementDeclaration):
        ...
        def __init__(self, **kw):
            kw["pname"] = ("http://session.ejb.gov.fnal/","Exception")
            kw["aname"] = "_Exception"
    ...
    class addRequest_Dec(ElementDeclaration):
        ...
        substitutionGroup = None
        def __init__(self, **kw):
            kw["pname"] = ("http://session.ejb.gov.fnal/","addRequest")
    ...
    class addRequestResponse_Dec(ElementDeclaration):
        ...
        substitutionGroup = None
        def __init__(self, **kw):
            kw["pname"] = ("http://session.ejb.gov.fnal/","addRequestResponse")
    ...
    class deleteRequest_Dec(ElementDeclaration):
        ...
        substitutionGroup = None
        def __init__(self, **kw):
            kw["pname"] = ("http://session.ejb.gov.fnal/","deleteRequest")
    ...
    class deleteRequestResponse_Dec(ElementDeclaration):
        ...
        substitutionGroup = None
        def __init__(self, **kw):
            kw["pname"] = ("http://session.ejb.gov.fnal/","deleteRequestResponse")
    ...
    class getRequestById_Dec(ElementDeclaration):
        ...
        substitutionGroup = None
        def __init__(self, **kw):
            kw["pname"] = ("http://session.ejb.gov.fnal/","getRequestById")
    ...
    class getRequestByIdResponse_Dec(ElementDeclaration):
        ...
        substitutionGroup = None
        def __init__(self, **kw):
            kw["pname"] = ("http://session.ejb.gov.fnal/","getRequestByIdResponse")
    ...
    class getRequestByStatus_Dec(ElementDeclaration):
        ...
        substitutionGroup = None
        def __init__(self, **kw):
            kw["pname"] = ("http://session.ejb.gov.fnal/","getRequestByStatus")
    ...
    class getRequestByStatusResponse_Dec(ElementDeclaration):
        ...
        substitutionGroup = None
        def __init__(self, **kw):
            kw["pname"] = ("http://session.ejb.gov.fnal/","getRequestByStatusResponse")
    ...
    class getRequestByUser_Dec(ElementDeclaration):
        ...
        substitutionGroup = None
        def __init__(self, **kw):
            kw["pname"] = ("http://session.ejb.gov.fnal/","getRequestByUser")
    ...
    class getRequestByUserResponse_Dec(ElementDeclaration):
        ...
        substitutionGroup = None
        def __init__(self, **kw):
            kw["pname"] = ("http://session.ejb.gov.fnal/","getRequestByUserResponse")
...
# end class ns0 (tns: http://session.ejb.gov.fnal/)
