...
#api.insertSubSystem(name="TIB_Percentage", parent="TIB_Local") (FLOAT) 
...
#api.insertSubSystem(name="TOB_Percentage", parent="TOB_Local") (FLOAT) 
...
#api.insertSubSystem(name="TEC_Percentage", parent="TEC_Local") (FLOAT) 
...
#api.insertSubSystem(name="TID_Percentage", parent="TID_Local") (FLOAT) 
...
#api.insertSubSystem(name="PXB_Percentage", parent="PXB_Local") (FLOAT) 
...
#api.insertSubSystem(name="PXF_Percentage", parent="PXF_Local") (FLOAT) 
#
#
...
#api.insertSubSystem(name="CSC_Percentage", parent="CSC_Local") (FLOAT) 
...
#api.insertSubSystem(name="RPC_Percentage", parent="RPC_Local") (FLOAT) 
...
#api.insertSubSystem(name="DT_Percentage", parent="DT_Local") (FLOAT) 
#
#
...
#api.insertSubSystem(name="EB_Percentage", parent="EB_Local") (FLOAT) 
#
...
#api.insertSubSystem(name="EE_Percentage", parent="EE_Local") (FLOAT) 
...
#api.insertSubSystem(name="ES_Percentage", parent="ES_Local") (FLOAT) 
...
#api.insertSubSystem(name="HB_Percentage", parent="HB_Local") (FLOAT) 
...
#api.insertSubSystem(name="HE_Percentage", parent="HE_Local") (FLOAT) 
...
#api.insertSubSystem(name="HF_Percentage", parent="HF_Local") (FLOAT) 
