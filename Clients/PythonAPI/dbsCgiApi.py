#!/usr/bin/env python
#
# $Id: dbsCgiApi.py,v 1.13 2006/03/09 15:24:18 lat Exp $
#
...
class InvalidCgiScriptUrl(DbsCgiApiException):
  def __init__ (self, **kwargs):
    DbsCgiApiException.__init__(self, **kwargs)

class CgiToolError(DbsCgiApiException):
  def __init__ (self, **kwargs):
    DbsCgiApiException.__init__(self, **kwargs)

class InvalidXML(DbsCgiApiException):
  def __init__ (self, **kwargs):
    DbsCgiApiException.__init__(self, **kwargs)

class DbsXmlParserException(DbsException):
  def __init__ (self, **kwargs):
    DbsException.__init__(self, **kwargs)
...
class DbsCgiApi(DbsApi):
  ...
  def getDatasetFileBlocks(self, processedDataset):
    """
    Retrieve a list of file blocks associated with a processed dataset.
    """
    return self._cgiUtility.getDatasetFileBlocks(processedDataset)

  def createPrimaryDataset(self, primaryDataset):
    """
    Create primary dataset.
    """
    return self._cgiUtility.createPrimaryDataset(primaryDataset)

  def createProcessedDataset(self, processedDataset):
    """
    Create processed dataset.
    """
    return self._cgiUtility.createProcessedDataset(processedDataset)
  ...
  def insertEventCollections(self, processedDataset, eventCollectionList):
    ...
    """
    return self._cgiUtility.insertEventCollections(processedDataset, eventCollectionList)

  def createFileBlock(self, processedDataset, fileBlock):
    """
    Create a new file block into a processed dataset.
    """
    return self._cgiUtility.createFileBlock(processedDataset, fileBlock)
