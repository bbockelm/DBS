...
public class DBSException extends Exception{
	...
	* @param message The exception berief message in string format to be stored in this DBSException class
	* @param code The exception general integer  code in string format to be stored in this DBSException class
