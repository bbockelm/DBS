...
public class SingleThreadedDatabaseQuerier {
	...
	public synchronized List getRecords(String query, PreparedStatement statement) throws SQLException, InterruptedException {
		ResultSet rs = null;
		try {
			//statement = conn.createStatement();
			rs = queryExecutor.executeQuery(statement, query);
