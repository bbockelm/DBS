...
int Insertapps_ClientAPIData::makeMessage(Message& messageOut) {
       ...
       if ( (int*)(&(t_collection_type_id.getValue())) != NULL ) {
          messageOut.addElement(new Element((string)"t_collection_type.id", (string)(util.itoa(t_collection_type_id.getValue())), (string)"INTEGER"));
      }
       ...
       if ( (string*)(&(t_collection_type_name.getValue())) != NULL ) {
          messageOut.addElement(new Element((string)"t_collection_type.name", (string)t_collection_type_name.getValue(), (string)"STRING"));
      }
...
int Insertapps_ClientAPIData::readInMessage(Message& messageIn, string lisName, int index) {
    ...
    value = messageIn.getElementValue("t_collection_type.id", lisName, index);
    if ( value != "NOTFOUND" ) {
        int intValue  = atoi(value.c_str());
        t_collection_type_id =  intValue;
    }
    ...
    value = messageIn.getElementValue("t_collection_type.name", lisName, index);
    if ( value != "NOTFOUND" ) {
        string strValue = (string) value;
        t_collection_type_name = strValue;
    }
