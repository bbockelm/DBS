...
<body>
			...
			<rich:dataTable columnClasses="column-index"
				...
				value="#{listFromBean}"
				var="fileVar">
				<f:facet name="header"> <h:outputText value="Streamer File" /></f:facet>
				<rich:column sortBy="#{fileVar.lumiId}">
					<f:facet name="header">	<h:outputText value=" Lumi Id"/></f:facet>
					<h:outputText value="#{fileVar.lumiId}"/>
				</rich:column> 
				...
				<rich:column sortBy="#{fileVar.streamerName}">
					<f:facet name="header">	<h:outputText value="Streamer Name"/></f:facet>
					<h:outputText value="#{fileVar.streamerName}"/>
				</rich:column> 
				<rich:column sortBy="#{fileVar.streamerId}">
					<f:facet name="header">	<h:outputText value="Streamer Id"/></f:facet>
					<h:outputText value="#{fileVar.streamerId}"/>
				</rich:column> 
