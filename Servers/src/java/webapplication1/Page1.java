...
import webapplication1.AnalysisDatasets;
...
public class Page1 extends AbstractPageBean {
    ...
    public String hyperlink4_action() {
        ...
        try {
            ...
            getSessionBean1().getAnalysisdsfilelumiRowSet().setObject(1, value);
            getSessionBean1().setCurrentAnalysisDSID((String)value);
        }
