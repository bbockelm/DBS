package gov.fnal.ms.ui.servlet;

import gov.fnal.ms.dm.entity.Request;
//import fnal.gov.ms.dm.session.MSSessionEJB;
import gov.fnal.ms.dm.session.MSSessionEJBLocal;
import gov.fnal.ms.ui.util.Util;
...
public class MigrationServlet extends HttpServlet {
    //@EJB(beanInterface=fnal.gov.ms.dm.session.MSSessionEJBLocal.class, name="ms/MSSessionEJB/local")
