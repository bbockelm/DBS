%  $Id: dm-dbs-tech-design.tex,v 1.10 2005/08/05 17:10:36 elmer Exp $
...
that the parameter set can be described by a single ID.}
...
Unlike the usual case for event collections, there is no guarantee that 
the entire input dataset will be processed into collections in the output
dataset, we do not explicitly introduce provenance relationships between
...
{\bf Add file block manipulation API}
