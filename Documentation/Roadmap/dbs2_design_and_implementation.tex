...
\end{enumerate}  & Riley, Kuznetsov, Dolgert, Lueking, Afaq, Sekhri  \\ \hline
Dec. 2006      & 
\begin{enumerate}
...
Jan. 2007  & 
\begin{enumerate} 
 \item Logging and monitoring details implemented.
 \item Continued stress testing w/ full estimated load and 2 years datasets
 \item Ready for production operation.
 \item Develop procedure for migrating data from DBS-1 as needed.
 \item Final documentation and test procedures.
 \item Additional discovery and integration with CMS DB areas.
 \end{enumerate}   &  \\ \hline
      \end{tabular}
    \end{center}
  \end{table}  
